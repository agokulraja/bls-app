      ...
      <div className="max-w-3xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl">
        <div className="md:flex">
          ...
          <div className="w-full p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-black"
                  value={formData.name}
              ...
              <div>
                ...
                <input
                  ...
                  type="email"
                  required
                  className="text-black block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
            ...
            {successMessage && <p className="text-red-800 mt-5">{successMessage}</p>}
